      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <div className="lg:text-center">
            <h2 className="text-base text-indigo-600 font-semibold tracking-wide uppercase">Transform Academic Chaos into effortless Calm</h2>
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              The hidden cost of traditional learning.
            </p>
          </div>
          <div className="mt-10">
            <div className="space-y-6">
              ...
              <ul className="text-lg text-gray-500 space-y-2">
                ...
                <li><strong>Active Recall:</strong> Train your brain to retrieve knowledge on demand—like a mental muscle.</li>
                <li><strong>Metacognition:</strong> Discover how to <em>think about your thinking</em> so you can spot gaps in your understanding before exams.</li>
