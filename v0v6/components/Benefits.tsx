        ...
        <div className="max-w-3xl mx-auto">
          <div className="lg:text-center">
            ...
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              Transform Academic Chaos into effortless Calm
            </p>
          </div>
          ...
          <div className="mt-10">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-500">
                Even top students struggle to keep up, especially as courses get harder. Extra effort and access to information does not guarantee success. Results depend on the “learning process” used.
              </p>
              <p className="text-lg text-gray-500">
