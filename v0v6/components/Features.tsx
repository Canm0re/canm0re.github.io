const experts = [
  {
    ...
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Josh-s8YQuogS272Ulwz8ezSHiLdsi2lOlb.png",
    description: (
      <>
          ...
          {experts.map((expert) => (
            <div key={expert.name} className="space-y-4">
              <img 
                ...
                alt={expert.name}
                title="Image specifications: 400x400px, high-quality headshot, professional setting, JPEG or PNG format"
              />
              <div>
