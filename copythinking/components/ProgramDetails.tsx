    ...
    <div className="py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ol className="list-decimal pl-5 space-y-2 text-lg mb-6">
          ...
          <li>They give you guidance and instruction</li>
          <li>Your knowledge increases</li>
        ...
        <img src="/placeholder.svg?height=400&width=800" alt="Learning How to Learn Course" className="w-full mb-6" />
        ...
        <ul className="list-disc pl-5 space-y-2 text-lg mb-12">
          <li>Everything you need to enhance your ability to memorize and recall any information</li>
          <li>How to Build a system for processing knowledge <em>faster</em>.</li>
          <li>How to Build a system for managing distractions and maintaining <em>focus</em>.</li>
          <li>How to Build a system for <em>balancing study</em> with other commitments.</li>
        </ul>
        ...
        <ul className="list-disc pl-5 space-y-2 text-lg mb-6">
          ...
          <li><strong>45%</strong> saw results in just <strong>30 days</strong></li>
        </ul>
        ...
        <ul className="list-disc pl-5 space-y-2 text-lg mb-12">
          ...
          <li>🔑 <strong>Instant Access to Kickstart Modules</strong> – Dive into our extensive library of materials, covering everything from procrastination management to advanced memory techniques, available to you the moment you enroll.</li>
          <li>💪 <strong>Procrastination-Busting Systems</strong> – Overcome distractions with powerful tools like the V-ABC and PEER-Peer frameworks, designed to help you stay focused and maximise your study time.</li>
          <li>🔄 <strong>Dynamic Revision Strategies</strong> – Never cram again. Implement our revision schedules and interleaving techniques to ensure continuous engagement with your material and prevent last-minute stress.</li>
          <li>📅 <strong>Time Management Mastery</strong> – Learn advanced scheduling techniques, such as the Eisenhower Matrix and Time Blocking, to balance your studies with other life commitments effortlessly.</li>
        ...
        <p className="text-lg text-gray-700 mb-6">
          And yet... This is only the beginning. The biggest chunk of information will be built <strong>with you.</strong>
        </p>
