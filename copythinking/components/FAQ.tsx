...
const faqs = [
  {
    ...
    answer: (
      <div className="space-y-4">
        <p>We have a <strong>pre-built library of content</strong> inside, covering everything from advanced note-taking techniques to stress management systems. But that's just the beginning.</p>
        
        <p className="font-bold">Here's what else you'll get:</p>
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Weekly live calls:</strong> Get personalized guidance, ask questions, and see real-time demonstrations of study techniques.</li>
          <li><strong>Ongoing discussions:</strong> Connect with other members, share tips, and troubleshoot challenges together.</li>
          <li><strong>Monthly cohorts:</strong> Dive deep into specific topics with focused, hands-on learning.</li>
        </ul>

        <p className="font-bold">Here are some examples of monthly cohorts we'll be running:</p>
        ...
        <p className="font-bold">And here's the best part: You get to shape the community.</p>
        <ul className="list-disc pl-5 space-y-2">
          <li>Suggest new cohort topics.</li>
          <li>Vote on what we cover next.</li>
          <li>Collaborate with other members to create resources and tools.</li>
        </ul>

        <p className="font-bold">This isn't just a program—it's a living, breathing community designed to help you succeed.</p>
      </div>
    )
  },
  {
